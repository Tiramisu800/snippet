...
import (
	...
	//// Import the models package that we just created(snippets.go)
...
type application struct {
	...
	//Add snippets field //Make SnippetModel obj available to handlers
...
func main() {
	...
	dbUrl := "postgresql://postgres:Zhak159*@localhost:5432/pgx_test"
